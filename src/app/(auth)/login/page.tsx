                ...
                <div className="space-y-4 text-center">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm font-medium text-muted-foreground/80 leading-relaxed max-w-[280px] mx-auto">
                            Sua inteligência financeira com design e simplicidade.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-8 bg-card/40 backdrop-blur-3xl p-8 rounded-[40px] border border-border/50 shadow-xl shadow-black/5">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase tracking-[0.25em] font-bold">
                            <span className="bg-card px-4 text-muted-foreground/60">ou gerenciar acesso</span>
                        </div>
                    </div>
                        ...
                        <div className="pt-4 space-y-4">
                            ...
                            <Link href="/signup" className="block w-full text-center">
                                <Button 
                                    variant="ghost" 
                                    type="button"
                                    className="w-full text-muted-foreground hover:text-foreground text-sm font-semibold tracking-tight"
                                >
